...
#The result shows the income mean of each state and its level as well. It #shows "tas" has the highest income mean while the "act" has the lowest #mean among eight state
```
...
#database therefore reflects this chronological grouping of the data. #You can create this dataset in Microsoft Excel.
